...
<body>
	...
	<!-- 
		Modernizr es una librería JavaScript que nos permite conocer la compatibilidad del navegador con tecnologías HTML5 y CSS3,
 		lo que nos permitirá desarrollar sitios web que se adapten a las capacidades cada navegador. -->
	<script src="js/modernizr-custom.js"></script>
        <!-- polyfiller file to detect and load polyfills -->
		<!-- Webshim es un polyfill biblioteca que le permite utilizar de forma fiable características de HTML5 en todos los navegadores,
		 incluso si el soporte nativo es insuficiente. -->
